 ...
 std::string –есурсныйћенеджер:: получить—троку‘айла(const std::string& относительный‘айлаѕути) 
{
 ...
 std::shared_ptr< –ендор::јнимаци€—прайт>–есурсныйћенеджер::загрускајнимаци€—прайт(const std::string& »м€—прайт,
																				   const std::string& »м€“екстур,
																				   const std::string& »м€Ўедора,
																				   const unsigned int спрайтЎирена,
																				   const unsigned int спрайт¬ысота,
																				   const std::string& расположение“екстур»м€)
 {
	 ...
	 std::shared_ptr<–ендор::јнимаци€—прайт> нова€—прайт = п_јнимаци€—прайт.emplace(»м€—прайт, std::make_shared<–ендор::јнимаци€—прайт>(п“екстур, пЎейдор,
																																		 расположение“екстур»м€,
																																		 glm::vec2(0.f, 0.f),
																																		 glm::vec2(спрайтЎирена, спрайт¬ысота))).first->second;
 ...
 std::shared_ptr< –ендор::јнимаци€—прайт>–есурсныйћенеджер::получатьјнимаци€—прайт(const std::string& »м€—прайт)
 {
 ...
 std::shared_ptr< –ендор::“екстуры2D> –есурсныйћенеджер::загруска“екстурјтлос(std::string »м€“екстур,
