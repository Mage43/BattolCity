...
class «емл€ : public »»гровыхќбъектов
{
public:
	«емл€(const std::shared_ptr<ƒвижок–ендеринга::—прайт> п—прайт , const glm::vec2& позици€, const glm::vec2& размер, const float вращение);
